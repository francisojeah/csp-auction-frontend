    ...
    <div className="w-full h-screen flex items-start">
      ...
      <div className="max-w-[500px] sm:w-1/2 w-full h-full bg-[#f5f5f5] flex flex-col p-20 justify-between items-center">
        ...
        <div className="w-full flex flex-col max-w-[500px]">
          ...
          <div className="w-full text-[#0b469c] my-2 bg-white border-1 border-black/40 font-semibold rounded-md p-4 text-center flex items-center justify-center cursor-pointer">
